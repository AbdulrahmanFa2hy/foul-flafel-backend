...
class MealsService {
  createMeals: any = expressAsyncHandler(
  ...
  getMealById: any = expressAsyncHandler(
    async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  ...
  getAllMeals: any = expressAsyncHandler(
    async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  ...
  updateMeal: any = expressAsyncHandler(
    async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      const meal: Meal | null = await mealSchema.findByIdAndUpdate(
        req.params.id,
        {
          $set: req.body,
        },
  ...
  deleteMeal: any = expressAsyncHandler(
    async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      const meal: Meal | null = await mealSchema.findByIdAndDelete(
        req.params.id
      );
      if (!meal) {
        return next(new ApiError(`${req.__("not_found")}`, 404));
